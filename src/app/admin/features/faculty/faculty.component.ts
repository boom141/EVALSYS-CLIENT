...
export class FacultyComponent {
  ...
  select_faculty(row_data: any) {
    ...
    this.infocards_data = this.selected_faculty.data.info_cards;
    this.barchart_data = this.selected_faculty.data.sentiment_data;
    this.donut_data = this.selected_faculty.data.participation_score;
    this.postive_sentiments_data =
      this.selected_faculty.data.sentiment_data.positive.feedbacks;
    this.neutral_sentiments_data =
      this.selected_faculty.data.sentiment_data.neutral.feedbacks;
    this.negative_sentiments_data =
      this.selected_faculty.data.sentiment_data.negative.feedbacks;
